...
public class AppointmentController {
    ...
    // GET /api/appointments/patient/{patientId}/status/{status} - Get appointments by patient ID and status
    ...
    // GET /api/appointments/clinic/{clinicId}/status/{status} - Get appointments by clinic ID and status
    ...
    // GET /api/appointments/patient/{patientId}/date-range - Get appointments by patient ID and date range
    ...
    // GET /api/appointments/clinic/{clinicId}/date-range - Get appointments by clinic ID and date range
